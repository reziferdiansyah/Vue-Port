<template>
     <div><div id="workexperience" class="sectionClass">
  <div class="row ">
      ...
      <ul class="cbp_tmtimeline">
        <li>
          ...
          <div class="cbp_tmlabel wow fadeInRight animated">
            ...
            <div class="date">
              <i class="fa fa-calendar"></i>Mei 2021 - Juli 2021
            </div>
            <h4><i class="fa fa-flag"></i>Sagara Technology</h4>
            <p class="projectParagraph"> 
              - Develop web apps with JavaScript use Framework ReactJS, Next JS, HTML, & Bootstrap.
              <br>
              - Work with Backend team and UI/UX Designer.
              <br>
              - Discussions and meetings with Team report daily Schedule.
              <br>
              - Problem Solving.
            </p>
          </div>
        ...
        <li>
          ...
          <div class="cbp_tmlabel wow fadeInRight animated">
            <h3>Frontend Developer</h3>
            <h4><i class="fa fa-flag"></i>Cikatech</h4>
            <div class="date"><i class="fa fa-calendar"></i>Oktober 2021 - September 2024</div>
            <p class="projectParagraph">
              - Develop web apps with JavaScript framework VueJS, Nuxt JS, HTML, & Tailwind CSS
              <br>
              - Work with Backend team and UI/UX Designer.
              <br>
              - Discussions and meetings with Team report daily Schedule.
            ...
            <p class="projectParagraph">
              ...
              - Review Code.  
              <br>
              - Discussions and meetings with Project Manager daily Schedule.
              <br>
              - Discussion with the team for daily tasks that must be completed.
              <br>
